#ifndef __TERZA_SCENE_H__
#define __TERZA_SCENE_H__
...
class TerzaScene : public cocos2d::Layer
{
	//uccello inizio
...
public:
    ...
    void setupTest(void);
    void setupTest2(TerzaScene *seStesso);
