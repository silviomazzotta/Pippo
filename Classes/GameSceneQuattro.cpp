...
Scene* GameSceneQuattro::createScene()
{
   ...
   // scene->getPhysicsWorld()->setGravity( Vec2( 0, 0 ) );
    ...
    auto layer = GameSceneQuattro::create();
...
void GameSceneQuattro::onTouchMoved(cocos2d::Touch *touch, cocos2d::Event *event)
{
...
void GameSceneQuattro::setInvisible(Node * node) {
...
void GameSceneQuattro::addPalline (float dt){
    cocos2d::log("GameSceneQuattro::addPalline .....");
