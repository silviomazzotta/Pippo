...
Scene* GameSceneTre::createScene()
{
   ...
   // scene->getPhysicsWorld()->setGravity( Vec2( 0, 0 ) );
    ...
    auto layer = GameSceneTre::create();
...
bool GameSceneTre::init()
{
 ...
 /*   {
    ...
    */
    ...
    contactListener->onContactBegin = CC_CALLBACK_1(GameSceneTre::onContactBegin, this);
    ...
    */
    ...
    listener->onTouchBegan = CC_CALLBACK_2(GameSceneTre::onTouchBegan, this);
    listener->onTouchMoved = CC_CALLBACK_2(GameSceneTre::onTouchMoved, this);
...
bool GameSceneTre::onContactBegin(cocos2d::PhysicsContact &contact)
{
	cocos2d::log("GameSceneTre::onContactBegin   ....... inizio   ");
  ...
  /*  if ( ( 1 == a->getCollisionBitmask() && 2 == b->getCollisionBitmask() ) || ( 2 == a->getCollisionBitmask() && 1 == b->getCollisionBitmask() ) )
    {
        CCLOG( "GameSceneTre::onContactBegin COLLISION HAS OCCURED" );
         ...
         if(pallinaBody){
			...
			//prendo tag
			  if (12 == pallinaBody->getTag()){
			        	  cocos2d::log("GameSceneTre::onContactBegin   colpita pallina 2  ");
                    //deve variare la y
			  ...
			  if (13 == pallinaBody->getTag()){
						        	  cocos2d::log("GameSceneTre::onContactBegin  colpita pallina 3   ");

                  pallinaBody->setVelocity(Vec2(randomValueTra(900,1900),
                		  randomValueTra(0,800)));
				}
			  if (14 == pallinaBody->getTag()){
			 						        	  cocos2d::log("GameSceneTre::onContactBegin  colpita pallina 4   ");
			  ...
			  if (15 == pallinaBody->getTag()){
			 						        	  cocos2d::log("GameSceneTre::onContactBegin   colpita pallina 5  ");
          ...
          if (PIETRA_TAG == a->getTag()){
        	//  cocos2d::log("GameSceneTre::onContactBegin   ....... 1  ");
          ...
          if (PIETRA_TAG == b->getTag()   ){
        	 // cocos2d::log("GameSceneTre::onContactBegin   ....... 2  ");
...
void GameSceneTre::onTouchMoved(cocos2d::Touch *touch, cocos2d::Event *event)
{
...
bool  GameSceneTre::onTouchBegan(Touch *touch, Event *unused_event){
 ...
 /*   auto moveToTargetPosition = MoveTo::create(1.2, targetPositionProiettileTo);
    ...
    proiettile->runAction(
                          Sequence::create(moveToTargetPosition,
                                           CallFuncN::create(CC_CALLBACK_1(GameSceneTre::setInvisible, this)),
                                           NULL )
                          );
...
void GameSceneTre::setInvisible(Node * node) {
    node->setVisible(false);
}


void GameSceneTre::addPartcleStella(Vec2 posizione) {
...
void GameSceneTre::addPalline (float dt){
    cocos2d::log("GameSceneTre::addPalline .....");
