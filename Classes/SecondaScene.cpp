...
//fonts/futura-48.fnt
const std::string SECONDA_FONT_CONTATORI = "font-issue1343.fnt";

//impostazione grafica sfondo
std::string SECONDA_PNG_MONTAGNA = "montagna.png";
std::string SECONDA_PNG_MONTAGNA_GIALLA = "montagna_gialla.png";
std::string SECONDA_PNG_PRATO = "prato.png";
std::string SECONDA_PNG_MURO = "muro.png";
std::string SECONDA_PNG_PALLINA_LABEL = "pietralabel.png";


std::string SECONDA_PNG_SFONDO_2 = "sfondo960640.png";
...
/*
    1) gestire in modo diverso lo sfondo
    2) inserire nuove palline
    3) magari non mettere le palline negative
    4) finisce solo quando vieni colpito
    5)

    cambiare il nome delle palline   sfera_%02d.png    in   secScenasfera_

*/

Scene* SecondaScene::createScene()
{
    // 'scene' is an autorelease object
    auto scene = Scene::create();

    // 'layer' is an autorelease object
    auto layer = SecondaScene::create();
...
//aggiunto gufo
    ...
    auto closeItem = MenuItemImage::create(
                                           "CloseNormal.png",
                                           "CloseSelected.png",
                                           CC_CALLBACK_1(SecondaScene::menuCloseCallback, this));
...
*/
  ...
  //  NOMI_SFONDO_VECTOR.push_back("montagna_5.png");
    ...
    // al limite poi facciamo random

    _montagna = Sprite::create(SECONDA_PNG_SFONDO_2);
...
#define MUMEROPALLINE 4
    ...
    */
    ...
    {
    	auto *pallina = PallinaSprite::pallinaSpriteWithFile("due_sfera_celeste.png");
    	pallina->setPunti(10);
   		 pallina->setVisible(false);
    	pallina->setTag(2);
    	this->addChild(pallina, 9);
    ...
    {
    	auto *pallina = PallinaSprite::pallinaSpriteWithFile("due_sfera_orange.png");
    	pallina->setPunti(10);
   		 pallina->setVisible(false);
    	pallina->setTag(3);
    	this->addChild(pallina, 9);
    ...
    {
    	auto *pallina = PallinaSprite::pallinaSpriteWithFile("due_sfera_rosa.png");
    	pallina->setPunti(10);
   		 pallina->setVisible(false);
    	pallina->setTag(4);
    	this->addChild(pallina, 9);
	...
	{
    	auto *pallina = PallinaSprite::pallinaSpriteWithFile("due_sfera_verde.png");
    	pallina->setPunti(10);
   		 pallina->setVisible(false);
    	pallina->setTag(5);
    	this->addChild(pallina, 9);
   ...
   // ******************************   HUD   ***********************************
    ...
    //TODO mettero pietra
    _labelLiv= Label::createWithBMFont(SECONDA_FONT_CONTATORI, "Lives");
    addChild(_labelLiv);
    ...
    //appare in alto a sinistra ********* PALLINA *****
     _pietraLabel =  Sprite::create(SECONDA_PNG_PALLINA_LABEL);
    ...
    auto per= Label::createWithBMFont(SECONDA_FONT_CONTATORI, "X");
    addChild(per,23);
    ...
    _livesDisplay = Label::createWithBMFont(SECONDA_FONT_CONTATORI, "0");
    ...
    //  Va posizionata rispetto a LivesDisplay
     auto labelSco = Label::createWithBMFont(SECONDA_FONT_CONTATORI, "Score");
    ...
    //  ****************   SCORE **********************
    _scoreDisplay = Label::createWithBMFont(SECONDA_FONT_CONTATORI, "0");
    ...
    //create main loop
    this->schedule(schedule_selector(SecondaScene::update));

    this->schedule(schedule_selector(SecondaScene::addPalline), 2.4f);
     //Modifiche per schena 2 
  	 this->schedule(schedule_selector(SecondaScene::addUccello), 5.0f); //Cancello
  	 this->schedule(schedule_selector(SecondaScene::addGugo), 7.0f);   // Cancello
  	 this->schedule(schedule_selector(SecondaScene::addPallineZigZag), 9.0f);
     //Fine Modifiche per schena 2 

    auto dispatcher = Director::getInstance()->getEventDispatcher();
    auto listener = EventListenerTouchOneByOne::create();

    listener->onTouchBegan = CC_CALLBACK_2(SecondaScene::onTouchBegan, this);
    //listener->onTouchMoved = CC_CALLBACK_2(SecondaScene::onTouchMoved, this);
...
void SecondaScene::addGugo(float dt){
    if (!_playing) return;
...
void SecondaScene::addUccello (float dt){
   if (!_playing) return;
   if (!(_statoDifficolta == LIVELLO4 || _statoDifficolta == LIVELLO6 ) ){
            ...
            cocos2d::log("SecondaScene::addUccello fine.....");
   }
...
void SecondaScene::addPallineZigZag (float dt){
    cocos2d::log("SecondaScene::addPallineZigZag  .....");
    Size visibleSize = Director::getInstance()->getVisibleSize();
    Vec2 origin = Director::getInstance()->getVisibleOrigin();
...
void SecondaScene::addPalline (float dt){
    cocos2d::log("SecondaScene::addPalline .....");
    if (!_playing) return;
   ...
   // auto seq2 = Sequence::create(moveToTargetPosition, NULL);
    ...
    pallina->runAction(
                       Sequence::create(moveToTargetPosition,
                                        CallFuncN::create(CC_CALLBACK_1(SecondaScene::setInvisible, this)),
...
void SecondaScene::setInvisible(Node * node) {
    node->setVisible(false);
}


bool  SecondaScene::onTouchBegan(Touch *touch, Event *unused_event){
...
void SecondaScene::update (float dt) {
    //the main loop
    if (!_playing) return;
    cocos2d::log("SecondaScene::update .....");
...
//void SecondaScene::stopGameAndMessageOLd()
...
/*
 ...
 sprite->setVisible(false);
	...
	auto restartItem = MenuItemLabel::create(restartLabel, CC_CALLBACK_1(SecondaScene::restartTapped, this));
...
//stoppo il game e mostro messaggio
/*
 void SecondaScene::stopGameAndMessage()
 {
 Size visibleSize = Director::getInstance()->getVisibleSize();
 Vec2 origin = Director::getInstance()->getVisibleOrigin();
 _playing = false;
 ...
 //	"gameoverbutton.png");
	...
	CC_CALLBACK_1(SecondaScene::restartTapped, this));
...
void SecondaScene::restartTapped(Ref* pSender) {
...
Sprite* SecondaScene::createEplosioneAnimata(){
...
void SecondaScene::setupActions()
{
    ...
    _groundHit = Sequence::create(
                                  ...
                                  CallFuncN::create(CC_CALLBACK_1(SecondaScene::animationDone, this)),
                                  NULL);
    _groundHit->retain();
...
void SecondaScene::setupGameOver()
{
...
void SecondaScene::ruotaGugutSinistra(PallinaSprite* pallinaSprite){
...
void SecondaScene::andLivesGugutSalta(){
	_statoGgugut = RUOTASINISTRA;
	   Size visibleSize = Director::getInstance()->getVisibleSize();
	  Vec2 origin = Director::getInstance()->getVisibleOrigin();
	  _gugutAnimato->stopAllActions();
...
void SecondaScene::gugutSaluta(PallinaSprite* pallinaSprite){
   	_statoGgugut = RUOTASINISTRA;
	   Size visibleSize = Director::getInstance()->getVisibleSize();
	  Vec2 origin = Director::getInstance()->getVisibleOrigin();
	  _gugutAnimato->stopAllActions();
...
void SecondaScene::muoviMontagnaScoglio(){
...
void SecondaScene::animationDone(Node *node)
{
    node->stopAllActions();
}
void SecondaScene::effettoGuadagnoPietre(Node *node)
{
...
void SecondaScene::controllaModificaDifficolta()
{
...
void SecondaScene::controllaPietre()
{
...
float SecondaScene::randomValueBetween(float low, float high)
{
    return (((float) random() / 0xFFFFFFFFu) * (high - low)) + low;
}
void SecondaScene::menuCloseCallback(Ref* pSender)
{
...
void SecondaScene::addParticelle() {
...
void SecondaScene::particelleRotFlower()
{
...
void SecondaScene::particellePallinaNegativa()
{
...
void SecondaScene::controllaPietraConPallinaBlu(Node *pietra)
{
