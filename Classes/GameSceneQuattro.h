...
#ifndef __gugut__GameSceneQuattro__
#define __gugut__GameSceneQuattro__
...
class GameSceneQuattro : public cocos2d::Layer
{
public:
...
#endif /* defined(__gugut__GameSceneQuattro__) */
