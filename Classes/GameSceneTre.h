...
#ifndef __gugut__GameSceneTre__
#define __gugut__GameSceneTre__
...
class GameSceneTre : public cocos2d::Layer
{
public:
...
#endif /* defined(__gugut__GameSceneTre__) */
